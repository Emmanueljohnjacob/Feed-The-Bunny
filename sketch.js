...
//
  ...
  score.scale=0.2
  score.addAnimation('nostar',nostar);
  
  score.addAnimation('onestar',onestar);

  score.addAnimation('twostars',twostars);
  score.changeAnimation('nostar')
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star2,20)==true){
    star2.visible=false;
    score.changeAnimation('twostars')
  }
}
